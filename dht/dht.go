...
func (d *DHT) Run() {
	...
	InfoHash := []byte{0xca, 0x9d, 0x9a, 0xf5, 0x56, 0x52, 0x67, 0x23, 0x7f, 0x9f, 0xc4, 0x22, 0x08, 0x7b, 0x23, 0x23, 0x1c, 0xce, 0x27, 0xc6}
	go d.Acquirer.Push(acquirer.NewPeerInfo(string(InfoHash), "37.78.112.0", 28711))
